...
import {addTaskListeners, getTaskListeners} from '../utils/ElementUtil'
  ...
  computed: {
    listenerList: {
      get () {
        ...
        const listenerObjs = getTaskListeners(businessObject, this.panelType).map(e => {
          const listenerObj = {}
      ...
      set (listenerList) {
        ...
        addTaskListeners(businessObject, listenerObjs, this.bpmnFactory, this.panelType)
